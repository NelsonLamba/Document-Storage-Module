...
public class ProductTransferPage extends WebBasePage {
    ...
    public void clickItemFromBreadCrumb() {
        click(By.xpath("//div[@id='SiteMapLink']//ol[@class='breadcrumb']//li//a[text()='Item']"), "Item", 20);
    ...
    public void selectLocation() {
        ...
        if (element != null) {
            ...
            click(By.xpath("//ul[@id='CompantLocationSelect']//li/a//span[text()='" + location + "']"), "Select Location", 30);
    ...
    public void selectUniqueName() {
        ...
        findElementClickable(By.xpath("//div[@class='unique_dynamicdatalist']"), 60);
        staticWait(3000);
        click(By.xpath("//div[@class='unique_dynamicdatalist']/ul/li[text()='" + uniqueName + "']"), "Select Unique Name", 30);
    }
    ...
    public void verifyTransferQuantityField() {
        ...
        if (alertMsg.equals("Transfer quantity not greater than available quantity.")) {
    ...
    public void selectToLocation() {
        ...
        if (element != null) {
            ...
            List<WebElement> elements = findMultipleElement(By.xpath("//ul[@id='CompantLocationSelecttransferItem']//li//ol//li//a/span"), 20);
            for (WebElement ele : elements) {
                String loca = ele.getText().trim();
    ...
    public void saveTheProductToAnotherLocationAndVerify() {
