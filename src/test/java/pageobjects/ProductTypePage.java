...
public class ProductTypePage extends WebBasePage
{
    ...
    {
        click(By.xpath("//table[@id='tblAsset']/tbody/tr/td[1]"),"CheckBox",20);
    }
    ...
    {
        click(By.xpath("//label[@for='IsEnableTerms']//parent::div//span[@class='slider round']"),"Terms And Conditions toggle",20);
    }
    ...
    public void clickProductTypeName()
    {
        click(By.xpath("//table[@id='tblAsset']/tbody/tr/td[4]/a"),"Product Type Name",20);
    }
    ...
    public void verifyNameChange()
    {
        ...
        if(changePName.equals(itemNameRandomValue))
        {
            ...
            logger.info("Changed Second Product name is displayed as expected as "+changePName);
        }
        else
        {
    ...
    public void verifyImportedProductOnProductListingPage() {
        try {
            ...
            if (!actualName.contains("false")) {
                ...
                takeScreenshot("Imported product type");
