...
public class DeployProduct  extends WebBasePage {
    WebDriver driver;
    List<String>locationNameList;
    CompanySetup companySetup;
    public DeployProduct(WebDriver driver)
    {
    ...
    {
        WebElement searchBar=findElementsPresence(By.cssSelector("input#assetSearch"),15);
        if(searchBar!=null)
    ...
    {
        /*String locationError="Location is required";
        String quantityError="Quantity should be greater than 0";
        String productCostError="Product Cost/Qty is required";
        String unitPriceError="Unit Price should be greater than 0";*/
    ...
    {
        int i=0;
        List<WebElement> locations=driver.findElements(By.cssSelector(".scrollbar>li>a>span"));
    ...
    public WebElement verifyWIthDate(String date)
    {
        ...
        click(By.cssSelector("[data-target='#txtOrderDate']"),"Calendar Icon",15);
    ...
    public void verifyWithOldDate()
    {
        WebElement dayElement=verifyWIthDate("Old");
        if(dayElement!=null)
        {
            click(By.xpath("By.xpath(\"//td[contains(@class,'day') and text()='\"+day+\"']\")"),"Day Value",15);
    ...
    public void verifyWithFutureDate()
    {
        WebElement dayElement=verifyWIthDate("Future");
        if(dayElement==null)
        {
    ...
    public void verifyWithCurrentDate()
    {
        WebElement dayElement=verifyWIthDate("Curent");
        if(dayElement==null)
        {
    ...
    public void verifyDateinInsurenceDate(String temp)
    {
        //String actualInsurenceDate=getAtribute(By.xpath("//div[@class='form-group']//div//input[@id='txtInsuranceToDate']"),"value",15);
        String monthandYear=getText(By.xpath("//table[contains(@class,'tabledatetimepicker')]//th[@title='Select Month']"),15);
        String date=getText(By.xpath("//table[contains(@class,'tabledatetimepicker')]//tr//td[contains(@class,'day active')]"),15);
        //if()
    }
}
